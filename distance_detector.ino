...
void loop() {
	/*
	 Here, we are activating the Ultrasonic Sensor. The sensor sends out pulses of sound waves and
	 uses them to measure the distance of an object (similar to a bat's echolocation).
	 This 'low' pulse creates a delay so that the 'high' pulse gives a better signal.
	 */
	...
	// To calculate in inches, replace the below line with this: distance = (duration/2) / 74;
